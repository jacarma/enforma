...
import { BasicDemo, DataSourceDemo, CascadingDemo, OpenChoiceDemo } from '../../../demos/SelectDemos';
...
<DataSourceDemo client:only="react" />
...
<CascadingDemo client:only="react" />
...
<OpenChoiceDemo client:only="react" />
